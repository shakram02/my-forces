...
int max_of_singles(const CharSet &, StrMap &);
...
int main()
{
    ...
    cout << max(max_of_singles(singles, chosen_words), max_of_doubles(chosen_words)) << endl;
    return 0;
}
...
int max_of_singles(const CharSet &cset, StrMap &strings_map)
{
    int max = 0;
